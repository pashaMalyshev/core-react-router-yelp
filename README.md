...
Подключите библиотеку компонентов. Например - https://github.com/alfa-laboratory/arui-feather

### Release 1: Список ресторанов
...
### Release 2: Страницы с параметром
...
### Release 3: Форма добавить отзыв
